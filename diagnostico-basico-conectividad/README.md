...
![Ping fallido Windows a Kali](./screenshots/03-ping-fallido-windows-kali.png)
...
Mientras tanto, Windows tenía una IP `169.254.x.x`, sin puerta de enlace válida. Esto confirmó que Windows no estaba correctamente dentro de la red NAT o no había recibido configuración DHCP válida.
...
![DHCP release](./screenshots/04-dhcp-release.png)

![DHCP renew con IP válida](./screenshots/05-dhcp-renew-ip-valida.png)
...
![IP corregida en Windows](./screenshots/06-ipconfig-windows-corregido.png)
...
![Ping al gateway VMware](./screenshots/07-ping-gateway-vmware.png)
...
![Ping Windows a Kali](./screenshots/08-ping-windows-kali.png)
